class Persona:
    ...
    def dormir(self):
        print("ZzZzZzZzZzZzZz que calors.... zZzz")
...
class ayudanteProfesor(Alumno, Profesor):
    ...
    def __str__(self):
        return Alumno.__str__(self) + str(self.numero_trabajador) + Profesor.__str__(self) + self.area + f"Horas de trabajo:  {self.horas}"
